...
'''
Notes: 
1. loc[row-selec, col-selec] 
    it filters out the output based on the
    row & col selection
2. iloc[R,C]
    it gives the element at the row R and col C
3. Difference between iloc and loc is, 
   loc uses labled based indexing, while iloc 
   uses indexed based positioning. 
   Also, unlike iloc, loc includes 
   both start and end, while 
'''
